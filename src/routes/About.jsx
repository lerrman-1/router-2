import retrato from '../assets/lerrman-1.jpg'
const About = () => {
    return (
        <div>
            <div className="min-h-screen bg-slate-50 w-full flex flex-col items-center justify-center gap-5">
                <h1 className="text-6xl font-bold text-black text-center mt-10">About</h1>
                <img src={retrato} className='w-80' alt="retrato" />
