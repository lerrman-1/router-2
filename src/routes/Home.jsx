import foto from '../assets/diapo-el-frio.jpg'
const Home = () => {
    return (
        <div className="min-h-screen bg-slate-50 w-full flex flex-col items-center justify-center gap-5">
            <h1 className="text-6xl font-bold text-black text-center mt-10">Home Page</h1>
            <img src={foto} className='w-3xl px-3.5' alt="foto" />
